...
if __name__ == "__main__":
    ...
    parser.add_argument('flightline',       help="Filepaths to flightline ENVI IMG.",
                                            type=str)
    parser.add_argument('--pad', '-p',     help="Pad input by 0 or more pixels",
                                            default=256,
                                            type=int)
    ...
    # 256 = (8,8)
    # 64 = (2,2)
    #fcn.add_module('pool_pad', nn.ReplicationPad2d(8))
    ...
    print(f'x.shape: {x.shape} @ pad={pad}')
    print(f'x[pad:-pad,pad:-pad].shape: {x[pad:-pad,pad:-pad].shape}')
